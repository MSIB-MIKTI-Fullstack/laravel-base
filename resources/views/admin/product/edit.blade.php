...
<li class="text-gray-500 dark:text-slate-400"><a href="{{ route('admin.product.index') }}" class="text-gray-500 dark:text-slate-400">Product</a></li>
<li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
