            ...
            table = new DataTable('#data-table', {
                ...
                columns: [{
                        ...
                        render: function(data, type, row, meta) {
                            if (data) {
                                return data.substring(0,
                                    40); // Mengambil substring dari karakter 0 hingga 40
                            }
                            return data; // Mengembalikan data asli jika tidak ada
                        }
                    },
                    {
                        data: 'description',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            if (data) {
                                return data + ' Gram'; // Menambahkan kata 'gram' setelah nilai weight
                            }
                            return data; // Mengembalikan data asli jika null atau undefined
                        }
                    },
                    {
                        data: 'price',
