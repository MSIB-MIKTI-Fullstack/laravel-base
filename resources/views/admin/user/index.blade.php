...
<div class="xl:w-full  min-h-[calc(100vh-56px)] relative pb-0">
    <div class="container my-4 p-4 bg-white">
        <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
            <a href="{{ route('admin.users.create') }}" class="px-2 py-1 bg-primary-500/10 border border-transparent collapse:bg-green-100 text-primary text-sm rounded hover:bg-blue-600 hover:text-white"><i class="ti ti-plus me-1"></i> New User</a>
