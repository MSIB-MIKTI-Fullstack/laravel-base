...
<li class="text-gray-500 dark:text-slate-400"><a href="{{ route('admin.users.index') }}" class="text-gray-500 dark:text-slate-400">Users</a></li>
<li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
<li><span class="text-gray-500 dark:text-slate-400">Edit User</span></li>
@endsection
@section('content')
...
<div class="flex-auto p-4 bg-white">
    <form action="{{ route('admin.users.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-2">
            ...
            <input type="email" id="email" name="email" class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-1 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700" required="" value="{{ $data->email }}">
        </div>
        <div class="mb-2">
