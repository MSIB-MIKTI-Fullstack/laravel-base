...
<li class="text-gray-500 dark:text-slate-400"><a href="{{ route('admin.product-categories.index') }}" class="text-gray-500 dark:text-slate-400">Product Categories</a></li>
<li><span class="text-gray-500 dark:text-slate-400 mx-2">/</span></li>
...
<div class="flex-auto p-4 bg-white">
    <form action="{{ route('admin.product-categories.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="mb-2">
