...
<div class="xl:w-full  min-h-[calc(100vh-56px)] relative pb-0">
    <div class="container my-4 p-4 bg-white">
        <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
            <a href="{{ route('admin.product-categories.create') }}" class="px-2 py-1 bg-primary-500/10 border border-transparent collapse:bg-green-100 text-primary text-sm rounded hover:bg-blue-600 hover:text-white"><i class="ti ti-plus me-1"></i>New Product Category</a>
...
<div class="modal animate-ModalSlide hidden" id="modalcenter">
    <div class="relative w-auto pointer-events-none sm:max-w-lg sm:my-0 sm:mx-auto z-[99] flex items-center h-[calc(100%-3.5rem)]">
        <form action="{{ route('admin.product-categories.destroy', 'id') }}" method="POST" enctype="multipart/form-data">
            @method('DELETE')
            @csrf
            <div class="relative flex flex-col w-full pointer-events-auto bg-white dark:bg-slate-800 bg-clip-padding rounded" style="left: 50%">
