                                ...
                                <ul class="blcok items-center lg:flex px-4 md:px-0">
                                    <li>
                                        <a href="{{ route('customer.home')}}"
                                            class="flex justify-between py-2 text-base font-medium {{ Route::is('customer.home') ? 'text-brand' : 'text-dark' }} hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                                            Home
                                        </a>
                                    </li>
                                    <li>
                ...
                <div class="w-full relative mb-4">
                    <div class="flex-auto p-4">
                        ...
                        <div class="flex sm:justify-center xl:justify-start">
                            <a href=""
                                class="w-8 h-8 leading-7 border-2 border-gray-500 rounded-full text-center content-center duration-300 text-gray-400 hover:text-white hover:bg-blue-600 hover:border-blue-600">
                                <i class="icofont-facebook"></i>
                            </a>
                            <a href=""
                                class="w-8 h-8 leading-7 border-2 border-gray-500 rounded-full text-center content-center duration-300 ml-2 text-gray-400 hover:text-white hover:bg-blue-400 hover:border-blue-400">
                                <i class="icofont-twitter"></i>
                            </a>
                            <a href=""
                                class="w-8 h-8 leading-7 border-2 border-gray-500 rounded-full text-center content-center duration-300 ml-2 text-gray-400 hover:text-white hover:bg-red-600 hover:border-red-600">
