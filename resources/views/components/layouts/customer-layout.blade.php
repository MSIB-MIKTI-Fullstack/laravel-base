...
<body data-layout-mode="light" data-sidebar-size="default" data-theme-layout="vertical" class="bg-[#EEF0FC]">
                    ...
                    <div class="w-full items-center justify-end px-4 sm:flex lg:justify-between">
                       ...
                       " onclick="event.stopPropagation()">
                            ...
                            <div class="dropdown relative">
                                <button type="button" class="dropdown-toggle flex rounded-full md:me-0 h-10 w-10 items-center justify-center  border-[.5px] dark:border-slate-700/40 bg-[#f4f7ff] text-dark" id="Notifications" aria-expanded="false" data-fc-autoclose="both" data-fc-type="dropdown">
                            ...
                            <div class="me-2  dropdown relative">
                                <button type="button" class="dropdown-toggle flex items-center rounded-full text-sm focus:bg-none focus:ring-0 md:me-0" id="user-profile" aria-expanded="false" data-fc-autoclose="both" data-fc-type="dropdown">
                                    <img class="h-8 w-8 rounded-full" src="{{ asset('design-system/assets/images/users/avatar-10.png') }}" alt="user photo" />
                                    ...
                                    <ul class="py-1" aria-labelledby="navUserdata">
                                        ...
                                        <li>
                                            <form action="{{ route('logout') }}" method="POST">
                                                @csrf
                                                <button type="submit" class="flex items-center py-2 px-3 text-sm text-red-400 hover:bg-gray-50 hover:text-red-500 w-full">
                            ...
                            @else
                            <a href="{{ route('login') }}" class="flex items-center py-2 px-3 text-sm hover:bg-gray-50">
                        ...
                        <div class="w-full">
                            ...
                            <nav id="mobile-menu-2" class="order-2 hidden w-full items-center justify-between md:order-1 md:ms-5 lg:flex md:w-auto">
                                <ul class="blcok items-center lg:flex px-4 md:px-0">
                                    <li>
                                        <a href="{{ route('customer.home') }}" class="flex justify-between py-2 text-base font-medium {{ Route::is('customer.home') ? 'text-brand' : '' }} hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                                            Home
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('customer.products') }}" class="flex justify-between py-2 text-base font-medium {{ Route::is('customer.products') ? 'text-brand' : 'text-dark' }} hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                                            Products
                                        </a>
                                    </li>
                                    <li>
                    ...
                    <div class="flex-auto p-4">
                        <div class="mb-5">
                            <a href="customers-home.html">
                                <img src="{{ asset('design-system/assets/images/logo-sm.png') }}" alt="" class="h-8 inline-block me-3">
                ...
                <div class="w-full relative mb-4">
                    <div class="flex-auto p-4">
                        ...
                        <ul class="list-none footer-links">
                            ...
                            <li class="mb-2">
                                <a href="#" class="border-b border-solid border-transparent text-slate-400 hover:border-white hover:text-white">Product
                                    details</a>
                            </li>
                            <li class="mb-2">
                ...
                <div class="w-full relative mb-4">
                    <div class="flex-auto p-4">
                        ...
                        <ul class="list-none footer-links">
                            ...
                            <li class="mb-2">
                                <a href="#" class="border-b border-solid border-transparent text-slate-400 hover:border-white hover:text-white">Add
                                    product</a>
                            </li>
                            <li class="mb-2">
                            ...
                            <li class="mb-2">
                                <a href="#" class="border-b border-solid border-transparent text-slate-400 hover:border-white hover:text-white">Order
                                    details</a>
                            </li>
                            <li class="mb-2">
    ...
    <script id="frostui" src="{{ asset('design-system/assets/libs/@frostui/tailwindcss/frostui.js') }}"></script>    <script src="{{ asset('design-system/assets/libs/nice-select2/js/nice-select2.js') }}"></script>
