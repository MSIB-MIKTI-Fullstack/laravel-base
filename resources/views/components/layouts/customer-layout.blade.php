                            ...
                            <div class="me-2  dropdown relative">
                                <button type="button" class="dropdown-toggle flex items-center rounded-full text-sm focus:bg-none focus:ring-0 md:me-0" id="user-profile" aria-expanded="false" data-fc-autoclose="both" data-fc-type="dropdown">
                                    ...
                                    <span class="ltr:ms-2 rtl:ms-0 rtl:me-2 hidden text-left xl:block">
                                        <span class="block font-medium text-slate-600"> {{ Auth::user()->name }}
                                        </span>
                                    </span>
                                </button>
                        ...
                        <div class="w-full">
                            ...
                            <nav id="mobile-menu-2" class="order-2 hidden w-full items-center justify-between md:order-1 md:ms-5 lg:flex md:w-auto">
                                <ul class="blcok items-center lg:flex px-4 md:px-0">
                                    ...
                                    <li>
                                        <a href=" {{ route('customer.products') }} " class="flex justify-between py-2 text-base font-medium {{ Route::is('customer.products') ? 'text-brand' : '' }} hover:text-brand lg:mx-5 lg:inline-flex lg:py-6 2xl:mx-6">
                                            Products
                                        </a>
                                    </li>
                                    <li>
