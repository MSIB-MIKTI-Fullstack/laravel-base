  ...
  <div class="ltr:flex flex-1 rtl:flex-row-reverse">
    <div class="page-wrapper relative ltr:ml-auto rtl:mr-auto rtl:ml-0 w-[calc(100%-260px)] px-4 pt-[64px] duration-300">
      ...
      <div class="xl:w-full  min-h-[calc(100vh-152px)] relative pb-14">
        ...
        <!-- footer -->
        <div class="absolute bottom-0 -left-4 -right-4 block print:hidden border-t p-4 h-[52px]">
          <div class="container">
            <!-- Footer Start -->
            <footer class="footer bg-transparent  text-center  font-medium text-slate-600 md:text-left ">
              &copy;
              <script>
                var year = new Date();
              ...
              Robotech
              <span class="float-right hidden text-slate-600 md:inline-block">Crafted with <i class="ti ti-heart text-red-500"></i> by Mannatthemes</span>
            </footer>
          </div>
        </div>
      </div>
