                ...
                <div class="left-auto right-0 z-50 my-1 hidden min-w-[300px]
                   ...
                   " onclick="event.stopPropagation()">
                    <div class="relative">
                        ...
                        <input type="text" id="email-adress-icon" class="block w-full rounded-lg border border-slate-200 bg-slate-200/10 p-1.5
                        pl-10 text-slate-600 outline-none focus:border-slate-300
                        focus:ring-slate-300 sm:text-sm" placeholder="Search..." />
                    </div>
                </div>
            </div>
                    ...
                    <ul class="py-1" aria-labelledby="navNotifications">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="flex">
                                    <div class="h-8 w-8 rounded-full bg-primary-500/20 inline-flex me-3">
                                        <span data-lucide="shopping-cart" class="w-4 h-4 inline-block text-primary-500 self-center mx-auto"></span>
                                    </div>
                        ...
                        <li class="py-2 px-4">
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="flex">
                                    <div class="h-8 w-8 rounded-full bg-primary-500/20 inline-flex me-3">
                                        <span data-lucide="user" class="w-4 h-4 inline-block text-primary-500 self-center mx-auto"></span>
                                    </div>
                                    <div class="flex-grow flex-1 ms-0.5 overflow-hidden">
                                        <p class="text-sm font-medium text-gray-900 truncate
                               ">
                        ...
                        <li class="py-2 px-4">
                            <a href="javascript:void(0);" class="dropdown-item">
                                <div class="flex">
                                    <img class="object-cover rounded-full h-8 w-8 shrink-0 me-3" src="design-system/assets/images/users/avatar-9.png') }}" alt="logo" />
                                    <div class="flex-grow flex-1 ms-0.5 overflow-hidden">
                                        <p class="text-sm font-medium  text-gray-900 truncate
                               ">
                ...
                <div class="left-auto right-0 z-50 my-1 hidden list-none
                    ...
                    <ul class="py-1" aria-labelledby="navUserdata">
                        ...
                        <li>
                         ...
                         ">
                                <span data-lucide="dollar-sign" class="w-4 h-4 inline-block text-slate-800 me-2"></span>
                                Earnings</a>
                        </li>
                        <li>
