       ...
       <ul class="py-1" aria-labelledby="navNotifications">
           ...
           <a href="javascript:void(0);" class="dropdown-item">
             <div class="flex">
               <img class="object-cover rounded-full h-8 w-8 shrink-0 me-3"
                 src="{{ asset('design-system') }}/assets/images/users/avatar-3.png" alt="logo" />
               <div class="flex-grow flex-1 ms-0.5 overflow-hidden">
                 <p class="text-sm font-medium text-gray-900 truncate
         ...
         <li class="py-2 px-4">
           <a href="javascript:void(0);" class="dropdown-item">
             <div class="flex">
               <img class="object-cover rounded-full h-8 w-8 shrink-0 me-3"
                 src="{{ asset('design-system') }}/assets/images/users/avatar-9.png" alt="logo" />
               <div class="flex-grow flex-1 ms-0.5 overflow-hidden">
                 <p class="text-sm font-medium  text-gray-900 truncate
   ...
   <div class="me-2  dropdown relative">
     <button
       ...
       <img
         ...
         src="{{ asset('design-system') }}/assets/images/users/avatar-1.png"
         alt="user photo"
         />
