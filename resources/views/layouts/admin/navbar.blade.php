                ...
                <div class="left-auto right-0 z-50 my-1 hidden list-none
                    ...
                    <ul class="py-1" aria-labelledby="navUserdata">
                        <li>
                         ...
                         ">
                         <span data-lucide="user" class="w-4 h-4 inline-block text-slate-800 me-2"></span>                                Profile</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center py-2 px-3 text-sm text-gray-700 hover:bg-gray-50
                        ...
                        <li>
                         ...
                         ">
                         <span data-lucide="power" class="w-4 h-4 inline-block text-red-500 me-2"></span>                                Sign out</a>
                        </li>
                    </ul>
                </div>
            </div>
