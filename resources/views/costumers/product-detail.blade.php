                            ...
                            <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                ...
                                <div class="sm:col-span-12  md:col-span-12 lg:col-span-6 xl:col-span-6 self-center">
                                    ...
                                    <div class="">
                                        ...
                                        <h6 class="text-[28px] text-slate-700 dark:text-slate-300 font-semibold mb-4">Rp.{{ number_format($product->price ,0 . 0 . 0 ) }} 
                                            <span class="text-base text-slate-400 font-semibold"><del>$180.00</del></span>
