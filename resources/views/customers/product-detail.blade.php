                    ...
                    <div class="flex-auto p-4">
                        ...
                        <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                            ...
                            <div class="sm:col-span-12  md:col-span-12 lg:col-span-6 xl:col-span-6 self-center">
                                <span
                                    class="bg-green-600/5 text-green-500 text-[14px] font-medium px-2.5 py-0.5 rounded h-5">
                    ...
                    <div
                        ...
                        <div class="flex-auto  text-center">
                            ...
                            <div class="flex-auto  text-center p-4">
                                <span
                                    class="focus:outline-none text-[12px] text-slate-500 border border-slate-200 rounded font-medium py-0 px-2 mb-5 inline-block">
                                    {{ $product->product_category->name }} </span>
                                <a href="{{ route('customer.products-detail', ['slug' => $product->slug]) }}"
                                    class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2 truncate">
                                    {{ $product->name }} </a>
                                <div class="mb-4">
