                        ...
                        <div class="flex-auto p-4">
                            <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                                ...
                                <div class="sm:col-span-12  md:col-span-12 lg:col-span-6 xl:col-span-6 self-center">
                                    <span class="bg-blue-100 text-blue-500 text-[14px] font-medium px-2.5 py-0.5 rounded h-5">{{ $product->product_category->name }}</span>
                ...
                <div class="sm:col-span-12  md:col-span-12 lg:col-span-12 xl:col-span-12">
                    <div class="w-full relative">
                        <div class="flex-auto ">
                            ...
                            <div id="myTabContent">
                                <div class="active p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                    ...
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center">
                            ...
                            <div class="flex-auto  text-center p-4">
                                ...
                                <a href="{{ route('customer.product-detail', ['slug' => $item->slug]) }}" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2 truncate">{{ $item->name }}
                                </a>
                                <div class="mb-4">
                                ...
                                <button type="button" class="px-4 py-1 lg:px-4 bg-transparent  text-brand text-base  transition hover:bg-brand-500/10 hover:text-brand-500 border border-slate-200 border-dashed font-medium w-full" onclick="location.href='{{ route('customer.product-detail', ['slug' => $item->slug]) }}'">Buy
                                    Now</button>
                            </div>
                        </div>
                    </div> <!--end card-->
