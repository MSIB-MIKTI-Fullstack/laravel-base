                            ...
                            <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6 self-center">
                                    <div class="flex-auto p-4">
                                        <div>
                                            <span class="bg-yellow-500 text-gray-900 p-2 rounded">Free Shipping - orders
                                                over $100</span>
                                            <h1 class="text-[40px] md:text-[50px] lg:text-[70px] leading-[80px] mb-10 font-normal">
                                                Limited Time Offer!<span class=" weight-animation  text-transparent text-5xl md:text-5xl lg:text-8xl bg-clip-text bg-gradient-to-r from-purple-500 to-pink-600">
                                                    Up To 50% OFF</span></h1>
                                            <p class="text-2xl text-slate-800 mb-10">Introduced a new model for online
                                                grocery shopping
                                                and convenient home delivery.</p>
                                            <button type="button" class="px-4 py-2 lg:px-6 bg-transparent  text-brand text-base  transition hover:bg-brand-500 hover:text-white  border-brand border-[2px] font-medium mb-2">Explore
                                                Store</button>
                                        </div>
                                    </div><!--end card-body-->
                                </div><!--end col-->
                        ...
                        <div class="flex-auto p-4">
                            <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-8 xl:col-span-8 self-center">
                                    <div class="flex-auto p-4 pb-0">
                                        <h4 class="text-4xl text-slate-800 font-semibold mb-0 font-spartan">Shoes
                                            Collection!</h4>
                                        <p class="text-slate-600 text-2xl mb-3 font-spartan">Launch Offer 15% Off!</p>
                                        <button type="button" class="px-4 py-2 lg:px-4 bg-brand-500  text-white text-base  transition hover:bg-brand-500 hover:text-white border border-brand border-dashed font-medium mb-2">View
                                            Collection</button>
                                    </div><!--end card-body-->
                                </div><!--end col-->
                    ...
                    <div class="bg-white shadow-sm dark:shadow-slate-700/10 dark:bg-gray-900  rounded-md w-full relative overflow-hidden">
                        ...
                        <div class="flex-auto p-4">
                            <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-8 xl:col-span-8 self-center">
                                    <div class="flex-auto p-4 pb-0">
                                        <h4 class="text-4xl text-slate-800 font-semibold mb-0 font-spartan">T-shirt
                                            Collection!</h4>
                                    ...
                                    <div class="flex-auto p-4 ">
                                        <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                                            <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                                                <div class="flex-auto p-4 ">
                                                    <a href="#">
                                                        <img src="{{ asset('design-system/assets/images/products/bl-1.png') }}" alt="" class="w-20 h-auto grayscale hover:grayscale-0 duration-500"> </a>
                                                </div><!--end card-body-->
                                            </div><!--end col-->
                                            <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                                                <div class="flex-auto p-4 ">
                        ...
                        <div class="flex-auto  text-center">
                            <div class="flex-auto text-center bg-gray-100">
                                <span class="absolute right-2 top-2 focus:outline-none text-[12px] bg-green-600/10 text-green-700 dark:text-green-600 rounded font-medium py-0 px-2 mb-5 inline-block">50%
                                    off</span>
                                <a href="#">
                                    <img src="{{ $product->image }}" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>
                            <div class="flex-auto  text-center p-4">
                                <span class="focus:outline-none text-[12px] text-slate-500 border border-slate-200 rounded font-medium py-0 px-2 mb-5 inline-block">{{ $product->product_category->name }}</span>
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">{{ $product->name }}</a>
                                <div class="mb-4">
                                        ...
                                        <div class="swiper-wrapper ">
                                            <div class="swiper-slide overflow-hidden">
                                                <div class="text-center h-[235px] flex justify-center bg-[url('../images/products/cos.png')] bg-cover py-10">
                                                    <div class="self-center">
                                                        <h4 class="font-spartan text-[42px] font-semibold mb-4">Beautiful
                                                            glamorous radiant</h4>
                                                        <p class="mb-4 text-xxl text-slate-500">It is a long established fact
                                                            that a reader will be distracted by the <br> readable content of a
                                                            page layout.</p>
                                                        <button type="button" class="px-4 py-2 lg:px-4 bg-brand-500  text-white text-base  transition hover:bg-brand-500 hover:text-white border border-brand border-dashed font-medium">View
                                                            Collection</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide overflow-hidden">
                                                <div class="text-center h-[235px] flex justify-center bg-[url('../images/products/jew.png')] bg-cover py-10">
                                                    <div class="self-center">
                                                        <h4 class="font-spartan text-[42px] font-semibold mb-4">Just Launched
                                                            new product
                                                        </h4>
                                                        <p class="mb-4 text-xxl text-slate-500">It is a long established fact
                                                            that a reader will be distracted by the <br> readable content of a
