                                        ...
                                        <div class="swiper defaultSwiper">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a href="#" class="">
                                                        <img src="{{ asset('design-system/assets') }}/images/products/pro-3.png" alt="" class="w-full h-auto p-10">
                                                    </a>
                                                </div>  
                                                <div class="swiper-slide">
                                                    <a href="#" class="">
                                                        <img src="{{ asset('design-system/assets') }}/images/products/pro-7.png" alt="" class="w-full h-auto p-10">
                                                    </a>
                                                </div>  
                                                <div class="swiper-slide">
                                                    <a href="#" class="">
                                                        <img src="{{ asset('design-system/assets') }}/images/products/pro-4.png" alt="" class="w-full h-auto p-10">
                                                    </a>
                                                </div>                         
                                            </div>
                                        </div>    
                        ...
                        <div class="flex-auto p-4">
                            <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">                                                   
                                ...
                                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-4 self-center">
                                    <div class="flex-auto p-4 ">
                                        <img src="{{ asset('design-system/assets') }}/images/products/pro-1.png" alt="" class="w-full h-auto z-[1] relative"> 
                                    </div><!--end card-body-->
                                </div><!--end col-->                                                                         
                            </div> <!--end grid-->
                        </div><!--end card-body-->                         
                    ...
                    <div class="bg-white shadow-sm dark:shadow-slate-700/10 dark:bg-gray-900  rounded-md w-full relative overflow-hidden" >
                        ...
                        <div class="flex-auto p-4">
                            <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">                                                   
                                ...
                                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-4 self-center">
                                    <div class="flex-auto p-4 ">
                                        <img src="{{ asset('design-system/assets') }}/images/products/pro-2.png" alt="" class="w-full h-auto z-[1] relative"> 
                                    </div><!--end card-body-->
                                </div><!--end col-->                                                                         
                            </div> <!--end grid-->
                        </div><!--end card-body-->                         
                                    ...
                                    <div class="flex-auto p-4 ">
                                        <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">   
                                            <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                                                <div class="flex-auto p-4 ">
                                                    <a href="#">
                                                        <img src="{{ asset('design-system/assets') }}/images/products/bl-1.png" alt="" class="w-20 h-auto grayscale hover:grayscale-0 duration-500"> 
                                                    </a>
                                                </div><!--end card-body-->
                                            </div><!--end col-->  
                                            <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                                                <div class="flex-auto p-4 ">
                                                    <a href="#">
                                                        <img src="{{ asset('design-system/assets') }}/images/products/bl-2.png" alt="" class="w-20 h-auto grayscale hover:grayscale-0 duration-500">
                                                    </a> 
                                                </div><!--end card-body-->
                                            </div><!--end col-->  
                                            <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                                                <div class="flex-auto p-4 ">
                                                    <a href="#">
                                                        <img src="{{ asset('design-system/assets') }}/images/products/bl-3.png" alt="" class="w-20 h-auto grayscale hover:grayscale-0 duration-500"> 
                                                    </a>
                                                </div><!--end card-body-->
                                            </div><!--end col--> 
                                            <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                                            ...
                                            <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                                                <div class="flex-auto p-4 ">
                                                    <a href="#">
                                                        <img src="{{ asset('design-system/assets') }}/images/products/bl-4.png" alt="" class="w-20 h-auto grayscale hover:grayscale-0 duration-500"> 
                                                    </a>
                                                </div><!--end card-body-->
                                            </div><!--end col-->                                                                        
                                        </div> <!--end grid-->
                    ...
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                ...
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/01.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                ...
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">White Table Camera </a>
                                <div class="mb-4">
                    ...
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                ...
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/04.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                ...
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">N95 Covid Safety Mask  </a>
                                <div class="mb-4">
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                ...
                <div class="sm:col-span-12  md:col-span-4 lg:col-span-3 xl:col-span-3 ">
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/03.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                ...
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">Imported VR Box  </a>
                                <div class="mb-4">
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                    ...
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                ...
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/02.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                ...
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">New Colorfull Shoes  </a>
                                <div class="mb-4">
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                    ...
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                <span class="absolute right-2 top-2 focus:outline-none text-[12px] bg-green-600/10 text-green-700 dark:text-green-600 rounded font-medium py-0 px-2 mb-5 inline-block">50% off</span>
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/pro-4.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                <span class="focus:outline-none text-[12px] text-slate-500 border border-slate-200 rounded font-medium py-0 px-2 mb-5 inline-block">Entertainment</span>
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">Mannat 530 Bluetooth Wireless </a>
                                <div class="mb-4">
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                    ...
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                <span class="absolute right-2 top-2 focus:outline-none text-[12px] bg-orange-500 text-white dark:text-orange-600 rounded font-medium py-0 px-2 mb-5 inline-block">Coming soon</span>
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/pro-1.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                <span class="focus:outline-none text-[12px] text-slate-500 border border-slate-200 rounded font-medium py-0 px-2 mb-5 inline-block">Footwear</span>
                ...
                <div class="sm:col-span-12  md:col-span-4 lg:col-span-3 xl:col-span-3 ">
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/pro-2.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                <span class="focus:outline-none text-[12px] text-slate-500 border border-slate-200 rounded font-medium py-0 px-2 mb-5 inline-block">Clothes</span>
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">Robo Men Oversized hoo - Blue </a>
                                <div class="mb-4">
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                    ...
                    <div class="bg-white dark:bg-gray-900 border border-slate-200 dark:border-slate-700/40  rounded-md w-full relative">
                        <div class="flex-auto  text-center"> 
                            <div class="flex-auto text-center bg-gray-100">
                                <span class="absolute right-2 top-2 focus:outline-none text-[12px] bg-red-600/10 text-red-500 dark:text-red-600 rounded font-medium py-0 px-2 mb-5 inline-block">Soldout</span>
                                <a href="#">
                                    <img src="{{ asset('design-system/assets') }}/images/products/pro-3.png" alt="" class="h-44 inline-block my-4 transition ease-in-out delay-50  hover:-translate-y-1 hover:scale-110 duration-500">
                                </a>
                            </div>                             
                            <div class="flex-auto  text-center p-4">
                                <span class="focus:outline-none text-[12px] text-slate-500 border border-slate-200 rounded font-medium py-0 px-2 mb-5 inline-block">Electric</span>
                                <a href="ecommerce-product-detail.html" class="text-xl font-semibold text-slate-500 dark:text-gray-400 leading-3 block mb-2">Mannat HD, Smart LED Fire TV  </a>
                                <div class="mb-4">
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                    <i class="icofont-star text-yellow-400 inline-block"></i>
                                ...
                                <h4 class="text-3xl font-medium dark:text-slate-300 mb-4"><sup class="text-sm text-slate-500">$</sup>199 <del class="text-base text-slate-400">$399</del></h4>                                                
                                <button type="button" class="px-4 py-1 lg:px-4 bg-transparent  text-brand text-base  transition hover:bg-brand-500/10 hover:text-brand-500 border border-slate-200 border-dashed font-medium w-full">Buy Now</button>
                            </div>
                        </div>
                    </div> <!--end card-->
                            ...
                            <div class="swiper defaultSwiper">
                                <div class="swiper-wrapper ">
                                    <div class="swiper-slide overflow-hidden">
                                        <div class="text-center h-[235px] flex justify-center bg-[url('../images/products/cos.png')] bg-cover py-10">
                                    ...
                                    <div class="swiper-slide overflow-hidden">
                                        <div class="text-center h-[235px] flex justify-center bg-[url('../images/products/jew.png')] bg-cover py-10">
                                            <div class="self-center">
