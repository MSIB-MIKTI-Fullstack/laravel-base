                                        ...
                                        <table class="min-w-full">
                                            <tbody>
                                                ...
                                                <tr class="border-b border-dashed border-slate-500/60 dark:border-slate-700/40">
                                                    ...
                                                    <td id="shipping-charge" class="p-3 text-sm font-medium text-gray-400 whitespace-nowrap">
                                                        -
                                                    </td>
                                                </tr>
                                                <!-- 3 -->
                                ...
                                <div class="grid grid-cols-4 gap-4">
                                    <div class="col-span-4 md:col-span-4 lg:col-span-4 xl:col-span-4">
                                        <div class="mb-2">
                                            ...
                                            <input class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-2 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-brand-500 dark:focus:border-brand-500  dark:hover:border-slate-700" placeholder="Address" type="text" name="address" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-2">
                                        <div class="mb-2">
                                            <label for="Email_Address" class="font-medium text-sm text-slate-600 dark:text-slate-400">Email
                                                Address</label>
                                            <input class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-2 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-sm hover:border-slate-400 focus:border-brand-500 dark:focus:border-brand-500  dark:hover:border-slate-700" placeholder="Enter Email" type="text" name="email_address" required>
                                        </div>
                                    </div>
                                    <div class="col-span-4 md:col-span-2 lg:col-span-1 xl:col-span-1">
                                        <div class="mb-2">
