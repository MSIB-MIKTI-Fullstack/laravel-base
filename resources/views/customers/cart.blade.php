                                ...
                                <div class="sm:-mx-6 lg:-mx-8">
                                    <div class="relative overflow-x-auto block w-full sm:px-6 lg:px-8">
                                        <table class="min-w-full">
                                            <tbody>
                                                <!-- 1 -->
                                                {{-- <tr class="border-b border-dashed border-slate-500/60">                                                    <td class="p-3 text-sm text-gray-300 whitespace-nowrap font-medium">
                                                        Subtotal
                                                    </td>
                                                ...
                                                {{-- <tr class="border-b border-dashed border-slate-500/60">                                                    <td class="p-3 text-sm text-gray-300 whitespace-nowrap font-medium"> Shipping
                                                    </td>
                                                    <td class="p-3 text-sm font-medium text-gray-400 whitespace-nowrap">
                                                        <div>
                                                ...
                                                <tr class="border-t-2 border-solid border-slate-500/60">
                                                    <td id="total-cart" class="p-3 text-base text-gray-200 whitespace-nowrap font-medium">
                                                        Total
                                                    </td>
                                                    <td class="p-3 text-base font-medium text-gray-100 whitespace-nowrap">
                                                        <div class="border-t-transparent border-solid animate-spin  rounded-full border-primary-500 border-2 h-4 w-4 inline-block">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                ...
                res.data.forEach(item => {
                    ...
                    <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                                        ...
                                                        <td
                                                            ...
                                                            <button type="button" class="text-red-500" onclick="deleteCart(this, ${item.id})">                                                                Remove
                                                            </button>
                                                        </td>
                                                    </tr>
                    `
