                    ...
                    <div
                        ...
                        <div class="flex-auto p-4">
                            ...
                            <div class="grid grid-cols-1 p-4 bg-slate-700/20 rounded-md">
                                ...
                                <div class="flex gap-4 mb-4" id="btn-checkout">
                                </div>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res.data.length > 0) {
                    ...
                    $('#btn-checkout').html(`
                    <button id="btn-back-to-shop"
                                        class="px-3 py-2 lg:px-4 bg-brand-500 collapse:bg-green-100 text-white text-sm font-semibold rounded hover:bg-brand-600 hover:text-white mt-4 lg:mb-0 w-1/2 inline-block"
                                        onclick="window.location.href =
                        {{ route('customer.products') }}">Continue
                                        ...
                                        onclick="window.location.href =
                        {{ route('customer.checkout.index') }}">Proceed
                                        to checkout</button>`)

                    $('#btn-back-to-shop').addClass('inline-block')
                    ...
                    $('#btn-checkout').html(`
                    <button id="btn-back-to-shop"
                                        class="px-3 py-2 lg:px-4 bg-brand-500 collapse:bg-green-100 text-white text-sm font-semibold rounded hover:bg-brand-600 hover:text-white mt-4 lg:mb-0 w-full"
                                        onclick="window.location.href =
                        {{ route('customer.products') }}">Continue
                                        shopping</button>`)
                    // $('#btn-checkout').remove()
