                            ...
                            <div class="grid grid-cols-1 p-4 bg-slate-700/20 rounded-md">
                                        ...
                                        <table class="min-w-full">
                                            <tbody>
                                                ...
                                                <tr class="border-t-2 border-solid border-slate-500/60">
                                                    ...
                                                    <td id="total-cart" class="p-3 text-base font-medium text-gray-100 whitespace-nowrap">
                                ...
                                <div class="flex gap-4 mb-4">
                                    <button class="px-3 py-2 lg:px-4 bg-brand-500 collapse:bg-green-100 text-white text-sm font-semibold rounded hover:bg-brand-600 hover:text-white w-1/2 mt-4 lg:mb-0 inline-block" onclick="window.location.href = `{{ route('customer.products') }}`">Continue
                                        shopping</button>
                                    <button id="btn-checkout" class="px-3 py-2 lg:px-4 bg-brand-500 collapse:bg-green-100 text-white text-sm font-semibold rounded hover:bg-brand-600 hover:text-white w-1/2 mt-4 lg:mb-0 inline-block" onclick="window.location.href = `{{ route('customer.checkout.index') }}`">Proceed
                                        to checkout</button>
                                </div>
