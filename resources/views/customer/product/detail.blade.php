<x-customer.app title="Product Detail">
  <div class="xl:w-full  min-h-[calc(100vh-0px)] relative pb-0">
              ...
              <div class="grid md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                ...
                <div class="sm:col-span-12  md:col-span-12 lg:col-span-6 xl:col-span-6 self-center">
                  ...
                  <div class="">
                    ...
                    <p tabindex="0"
                      class="focus:outline-none text-primary-500 dark:text-gray-400 text-base font-medium">Morden and
                      good look model 2023.</p>
                    <ul class="mb-4">
                    ...
                    <h6 class="text-[28px] text-slate-700 dark:text-slate-300 font-semibold mb-4"> Rp.
                    ...
                    <input
                      ...
                      style="width:100px;" type="number" min="0" value="0" id="example-number-input">
                    <button type="button"
              ...
              <div class="mb-4 border-b border-gray-200 dark:border-slate-700" data-fc-type="tab">
                <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" aria-label="Tabs">
                  <li class="me-2" role="presentation">
                    <button class="inline-block p-4 rounded-t-lg border-b-2 active " id="description-tab"
                      data-fc-target="#description" type="button" role="tab" aria-controls="description"
                  ...
                  <li class="me-2" role="presentation">
                    <button
                      class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                      id="reviews-tab" data-fc-target="#reviews" type="button" role="tab" aria-controls="reviews"
                      aria-selected="false">Ratings & reviews</button>
                  </li>
                </ul>
              </div>
              <div id="myTabContent">
                <div class="active  p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="description" role="tabpanel"
                  aria-labelledby="description-tab">
                  <p class="text-base text-gray-500 dark:text-gray-400">
                    {{ $product->description }}
                  </p>
                </div>
                <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="additional" role="tabpanel"
                        ...
                        <div class="flex-auto  text-center">
                          <table class="table border rounded-lg w-full">
                            ...
                            <tbody>
                              ...
                              <tr class="bg-white border-b border-dashed dark:bg-gray-900 dark:border-gray-700/40">
                                <td class="bg-brand-400/5 align-middle border-e border-dashed">
                                  <h6 class="mb-0 text-slate-800 uppercase font-semibold px-4 text-lg">Net Quantity
                                  </h6>
                                </td>
                              ...
                              <tr class="bg-white dark:bg-gray-900">
                                <td class="bg-brand-400/5 align-middle border-e border-dashed">
                                  <h6 class="mb-0 text-slate-800 uppercase font-semibold px-4 text-lg">Customer Reviews
                                  </h6>
                                </td>
                                <td class="p-4 mb-0">
                                  <div class="">
                ...
                <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="reviews" role="tabpanel"
                          ...
                          <form action="">
                            <div class="mb-2">
                              <label for="name-input"
                                class="font-medium text-sm text-slate-600 dark:text-slate-400">Name <span
                            ...
                            <div class="mb-2">
                              <label for="email-input"
                                class="font-medium text-sm text-slate-600 dark:text-slate-400">Email <span
                                  class="text-red-500 text-lg">*</span></label>
                              <input type="text" id="email-input"
                                class="form-input w-full rounded-md mt-1 border border-slate-300/60 dark:border-slate-700 dark:text-slate-300 bg-transparent px-3 py-2 focus:outline-none focus:ring-0 placeholder:text-slate-400/70 placeholder:font-normal placeholder:text-base text-lg hover:border-slate-400 focus:border-primary-500 dark:focus:border-primary-500  dark:hover:border-slate-700">
                            </div>
                            <label for="email-input"
                              class="font-medium text-sm text-slate-600 dark:text-slate-400">Your rating <span
                                class="text-red-500 text-lg">*</span></label>
                            ...
                            <div class="mb-2">
                              <label for="message"
                                class="font-medium text-sm text-slate-600 dark:text-slate-400">Your message</label>
            ...
            <div class="flex-auto  text-center">
              ...
              <div class="flex-auto  text-center p-4">
                ...
                <h4 class="text-3xl font-medium dark:text-slate-300 mb-4"><sup
                    class="text-sm text-slate-500">$</sup>49 <del class="text-base text-slate-400">$99</del></h4>
                <button type="button"
          ...
          <div
            ...
            <div class="flex-auto  text-center">
              ...
              <div class="flex-auto  text-center p-4">
                ...
                <h4 class="text-3xl font-medium dark:text-slate-300 mb-4"><sup class="text-sm text-slate-500">$</sup>9
                  <del class="text-base text-slate-400">$19</del></h4>
                <button type="button"
                  class="px-4 py-1 lg:px-4 bg-transparent  text-brand text-base  transition hover:bg-brand-500/10 hover:text-brand-500 border border-slate-200 border-dashed font-medium w-full">Buy
                  Now</button>
              </div>
          ...
          <div
            ...
            <div class="flex-auto  text-center">
              ...
              <div class="flex-auto  text-center p-4">
                ...
                <h4 class="text-3xl font-medium dark:text-slate-300 mb-4"><sup
                    class="text-sm text-slate-500">$</sup>29 <del class="text-base text-slate-400">$39</del></h4>
                <button type="button"
                  class="px-4 py-1 lg:px-4 bg-transparent  text-brand text-base  transition hover:bg-brand-500/10 hover:text-brand-500 border border-slate-200 border-dashed font-medium w-full">Buy
                  Now</button>
              </div>
          ...
          <div
            ...
            <div class="flex-auto  text-center">
              ...
              <div class="flex-auto  text-center p-4">
                ...
                <h4 class="text-3xl font-medium dark:text-slate-300 mb-4"><sup
                    class="text-sm text-slate-500">$</sup>99 <del class="text-base text-slate-400">$199</del></h4>
                <button type="button"
                  class="px-4 py-1 lg:px-4 bg-transparent  text-brand text-base  transition hover:bg-brand-500/10 hover:text-brand-500 border border-slate-200 border-dashed font-medium w-full">Buy
                  Now</button>
              </div>
    ...
    <div class="container">
      ...
      <div class="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-4 pt-10">
        <div class="w-full relative mb-4">
          <div class="flex-auto p-4">
            ...
            <p class="text-slate-500 text-lg">It is a long established fact that a reader will be distracted by the
      ...
      <footer class="footer bg-transparent  text-center  font-medium text-slate-400 dark:text-slate-400 md:text-left ">
        &copy;
        <script>
          var year = new Date();
