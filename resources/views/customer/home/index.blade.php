                ...
                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6 self-center">
                  <div class="flex-auto p-4">
                    <div>
                      ...
                      <h1 class="text-[40px] md:text-[50px] lg:text-[70px] leading-[80px] mb-10 font-normal">Limited
                        Time Offer!<span
                    ...
                    <div class="swiper defaultSwiper">
                      <div class="swiper-wrapper">
                        <div class="swiper-slide">
                          <a href="#" class="">
                            <img src="/design-system/assets/images/products/pro-3.png" alt=""
                              class="w-full h-auto p-10">
                          </a>
                        </div>
                        <div class="swiper-slide">
                          <a href="#" class="">
                            <img src="/design-system/assets/images/products/pro-7.png" alt=""
                              class="w-full h-auto p-10">
                          </a>
                        </div>
                        <div class="swiper-slide">
                          <a href="#" class="">
                            <img src="/design-system/assets/images/products/pro-4.png" alt=""
                              class="w-full h-auto p-10">
                          </a>
                        </div>
                      </div>
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-6">
          <div
            ...
            <div class="absolute end-36 z-0 hidden md:block">
              <img src="/design-system/assets/images/products/p-1.png" alt="">
            </div>
            <div class="flex-auto p-4">
              <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                ...
                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-4 self-center">
                  <div class="flex-auto p-4 ">
                    <img src="/design-system/assets/images/products/pro-1.png" alt=""
        ...
        <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-6 xl:col-span-6">
          <div
            ...
            <div class="absolute end-0 bottom-0 z-0">
              <img src="/design-system/assets/images/products/p-2.png" alt="">
            </div>
            <div class="flex-auto p-4">
              <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-8 xl:col-span-8 self-center">
                ...
                <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-4 self-center">
                  <div class="flex-auto p-4 ">
                    <img src="/design-system/assets/images/products/pro-2.png" alt=""
                      class="w-full h-auto z-[1] relative">
                  </div><!--end card-body-->
                </div><!--end col-->
              </div> <!--end grid-->
                  ...
                  <div class="flex-auto p-4 ">
                    <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12">
                      <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                        <div class="flex-auto p-4 ">
                          <a href="#">
                            <img src="/design-system/assets/images/products/bl-1.png" alt=""
                      ...
                      <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                        <div class="flex-auto p-4 ">
                          <a href="#">
                            <img src="/design-system/assets/images/products/bl-2.png" alt=""
                              class="w-20 h-auto grayscale hover:grayscale-0 duration-500">
                          </a>
                        </div><!--end card-body-->
                      </div><!--end col-->
                      <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                        <div class="flex-auto p-4 ">
                          <a href="#">
                            <img src="/design-system/assets/images/products/bl-3.png" alt=""
                              class="w-20 h-auto grayscale hover:grayscale-0 duration-500">
                          </a>
                        </div><!--end card-body-->
                      </div><!--end col-->
                      ...
                      <div class="col-span-6 sm:col-span-6 md:col-span-3 lg:col-span-2 xl:col-span-2 self-center">
                        <div class="flex-auto p-4 ">
                          <a href="#">
                            <img src="/design-system/assets/images/products/bl-4.png" alt=""
                              class="w-20 h-auto grayscale hover:grayscale-0 duration-500">
                          </a>
                        </div><!--end card-body-->
                      </div><!--end col-->
                  ...
                  <div class="swiper-slide overflow-hidden">
                    <div
                      ...
                      <div class="self-center">
                        ...
                        <p class="mb-4 text-xxl text-slate-500">It is a long established fact that a reader will be
                          distracted by the <br> readable content of a page layout.</p>
                        <button type="button"
